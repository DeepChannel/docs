...
2. Authenticate using `gcloud`
   ```sh
   gcloud auth application-default login --scopes=https://www.googleapis.com/auth/bigquery,https://www.googleapis.com/auth/drive.readonly,https://www.googleapis.com/auth/iam.test,https://www.googleapis.com/auth/cloudplatformprojects.readonly
   ```

:::note

Deep Channel requires additional Scopes; Please ensure you include all the scopes as stated in the command above.
...
```
## Databricks Profiles
Databricks support will be added in March 2023.
